...
class SavedAdapterSeller(var activity: Activity, var data: MutableList<product>) :
    RecyclerView.Adapter<SavedAdapterSeller.MyViewHolder>() {
...
//         .error(R.drawable.img).into(holder.saved_img)
    ...
    private fun deleteProductSaved(id:String,position: Int,holder: MyViewHolder, tokinCraft: String){
        val url = Url.api + "buyer/SavedProducts/delete"
