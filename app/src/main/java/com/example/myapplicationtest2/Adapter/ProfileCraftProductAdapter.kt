...
class ProfileCraftProductAdapter(var activity: Activity, var data: MutableList<newproduct>) :
    RecyclerView.Adapter<ProfileCraftProductAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(activity).inflate(R.layout.most_sale2, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.card.setOnClickListener {
            ...
            editor.putString("NCat", data[position].product_cat)
        ...
        holder.btn_saved.setOnClickListener {
            addtoSaved(data[position].new_id!!,tokinCraft)
        }

    }

    private fun addtoSaved(id: String, tokinCraft: String) {
